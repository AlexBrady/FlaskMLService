...
def get_midfielders():
    ...
    MidfielderModal = pd.read_csv('../resources/MIDFIELDERS.csv', sep=',', encoding='utf-8')
    players = MidfielderModal[8691:]
    ...
    X = MidfielderModal.drop(['total_points', 'player_id', 'season', 'name'], axis=1)
