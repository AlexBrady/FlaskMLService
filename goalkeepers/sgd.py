...
model = data[['pos', 'round', 'team_rank', 'opponent_team_rank', 'team_pot', 'opp_pot', 'save_form',
              'concede_pot', 'opp_concede_pot', 'prev_points', 'form_points', 'total_points',
              'long_form', 'ict_form']]

DefenderModal = model.loc[model['pos'] == 'Goalkeeper']
...
X = DefenderModal.drop(['total_points', 'long_form', 'ict_form', 'team_pot', 'opp_concede_pot'], axis=1)
...
testing.to_csv('../resources/GOALK_SDG.csv', sep=',', encoding='utf-8')
